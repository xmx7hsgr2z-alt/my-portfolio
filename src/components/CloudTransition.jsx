...
const youtubeIntroUrl =
  'https://www.youtube-nocookie.com/embed/PeY9pWJ2Mbk?autoplay=1&mute=1&controls=0&disablekb=1&fs=0&iv_load_policy=3&rel=0&modestbranding=1&playsinline=1&loop=1&playlist=PeY9pWJ2Mbk&start=0&end=7'
...
export default function CloudTransition() {
  ...
  return (
    <div className={`cloud-transition ${isFading ? 'is-fading' : ''}`} aria-hidden="true">
      ...
      <div className="cloud-control-cover" />
