...
import CircularSplitRoll from './ui/circular-split-roll.jsx'
...
export default function ShowcaseSection() {
  ...
  return (
    <>
      {/* 1. Primary 3D Circular Split Roll Work Showcase Section */}
      <section id="work" className="w-full relative z-20">
        <CircularSplitRoll />
      </section>

      {/* 2. Scene 2 Canvas Sequence Reel placed below Work Showcase */}
      <section ref={containerRef} id="showcase" className="relative w-full h-[250vh] sm:h-[320vh] bg-[#050505] border-t border-white/10">
        {/* Sticky Viewport Container for Scene 2 Animation */}
